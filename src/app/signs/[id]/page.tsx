...
import { SignData, SignDataStr } from "@/types";
import { TextSkeleton } from "@/ui/Skeleton";
import { getSignCache } from "@/services/cacher";
...
async function LoadSignData({ id }: { id: string }) {
  ...
  const finalData = data as unknown as SignData; //the data will be most likey a non-arry but later this migth be hekpful
